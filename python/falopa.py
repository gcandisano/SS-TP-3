...
# Seleccionar solo tiempos hasta 400 s para graficar
mask_plot = times <= 400
times_plot = times[mask_plot]
...
# Ajuste lineal solo hasta 200 s
...
plt.plot(times_sampled, MSD_sampled, 'b-', linewidth=1, label='Curva unida')
...
plt.ylabel("MSD <r²> (m²)", fontsize=12)
